...
limma_DEA_results <- list(Tram_vs_Parental = compare_samples(x,"none",
                                                   "Trametinib"),
                TramMCP1_vs_Parental = compare_samples(x,"none",
                                                   "Trametinib+MCP-1")
                Tram_vs_TrMCP1 = compare_samples(x,"Trametinib+MCP-1",
                                                   "Trametinib"),
                TrMCP1_vs_Parental = compare_samples(x,"none",
                                                   "Trametinib+MCP-1"))
